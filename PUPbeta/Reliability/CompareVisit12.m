...
[~,~,StudyID] = xlsread('D:\MrOS\Visit2\PUPStart\AMasterSpreadsheet_1026visit2.xlsx',1,'T4:T1029');
...
if 1
    ...
    % age, bmi
    Demo1=readtable('C:\Users\rma56\Dropbox (Partners HealthCare)\Reliability Trait Analysis\MrOS\NSRR Table\mros-visit1-dataset-0.3.0.csv');
    
    % sleep metrics
    IdLink=readtable('C:\Users\rma56\Dropbox (Partners HealthCare)\Reliability Trait Analysis\MrOS\NSRR Excel sheets\mros_id_linking.csv');
    
    %PSG1 has different id- need to link back to nsrr id using IdLink excel
    %sheet
    PSG1=readtable('C:\Users\rma56\Dropbox (Partners HealthCare)\Reliability Trait Analysis\MrOS\NSRR Excel sheets\mros1psg_20121019.csv');
    ...
    mrosendotypesV1=load('C:\Users\rma56\Dropbox (Partners HealthCare)\Reliability Trait Analysis\MrOS\Summary\SummaryAnalysis_V1_AllSleep_AllPos_BootT_Oct092021.mat');
    % get ids from excel sheet
    [~,~,IdV1] = xlsread('D:\MrOS\Visit1\PUPStart\AMasterSpreadsheet.xlsx',1,'T4:T2909');
   ...
   if 1 % find V2 subset patient flow
       ...
       Demo2=readtable('C:\Users\rma56\Dropbox (Partners HealthCare)\Reliability Trait Analysis\MrOS\NSRR Table\mros-visit2-dataset-0.3.0.csv');
