...
settingsDefault.MouthBreathingPDThreshold = 39.925; % EAS added on 2022-01-04 to detect mouth breathing
...
%settings.useWSanalysisToReplaceAr==1 				%uses autoscored arousals, standard 
%settings.useWSanalysisToReplaceAr==2 				%uses autoscored arousals, uses autoselected "best' EEG (use for when there is not staging, or human scoring is worse than no info) 
